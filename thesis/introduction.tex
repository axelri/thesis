...
This report presents some results that to the authors' knowledge has not been presented so far. Lumines computational complexity has not been established and this report gives solid indications that it is NP-complete. Furthermore the authors' has not seen the subset sum problem used much in reductions when considering the complexity of video games.
