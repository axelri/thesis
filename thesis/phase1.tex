...
\begin{lem}
In phase 1, for each well: Column 1 is unchanged. Column 2-4 will be filled below row $2 \left( \sum Q + K + 1 \right) - 3$. Column 5 is empty as long as the well is not blocked.
\end{lem}
