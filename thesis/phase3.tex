...
In \autoref{fig:placementc} we see the special case where the player has placed all $\mathbf{H}$ in the same well and then closed the well. This gameboard does not allow for an optimal clearing of cells. For a proof of this, please see Appendix \ref{specialcasereduction}
